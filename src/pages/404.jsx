      ...
      <div className="md:max-w-[1200px] mx-auto h-full border-x border-zinc-100 dark:border-zinc-800 bg-white dark:bg-zinc-950">
        <div className="flex h-screen justify-center px-6">
          <div className="self-center text-zinc-900 dark:text-zinc-300">
            ...
            <div className="text-center leading-7 mt-6 text-lg font-light text-text0">
              I can&lsquo;t able to find the page you&lsquo;re looking for.
              <br />
              Sorry, The requested URL &quot;{window.location.href}&quot; was
              not found.
            </div>
            <div className="text-center mt-6">
              <button
                onClick={() => navigate("/")}
                className="bg-primary hover:bg-secondary text-white px-6 py-4 rounded-xl"
              >
                Go back to homepage
              </button>
            </div>
